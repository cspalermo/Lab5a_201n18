...
function sumAndMultiply(a, b, c) { //eslint-disable-line  
  ...
  var element3 = a + ' and ' + b + ' and ' + c + ' sum to ' + sum2 + '.';
  var element4 = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + multiply2 + '.';
  return [sum2, multiply2, element3, element4];
}
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  for (var i = 0; i < multArr.length; i++) {
    arrayMult = multiply(arrayMult, multArr[i])[0];
  }
  return [arrayMult, 'The numbers ' + testArray + ' have a product of ' + arrayMult + '.'];
}
